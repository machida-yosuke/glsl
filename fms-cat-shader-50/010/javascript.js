...
let prg = gl3.program.create_from_source(
    ...
    [ 'position' ],
    [ 3 ],
    [ 'resolution', 'mouse', 'time', 'textureRandom', 'textureCat' ],
    [ '2fv', '2fv', '1f', '1i', '1i' ]
);
if ( !prg ) { return; }
...
gl.bindTexture( gl.TEXTURE_2D, gl3.textures[ textureNumCat ].texture );
...
let render = () => {
    ...
    prg.push_shader( [ resolution, mousePosition, nowTime, textureNumRandom, textureNumCat ] );
