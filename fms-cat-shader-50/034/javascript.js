...
let prg = gl3.program.create_from_source(
    ...
    [ 'position' ],
    [ 3 ],
    [ 'resolution', 'mouse', 'mouseP', 'mouseDown', 'time', 'prevScene', 'textureCat' ],
    [ '2fv', '2fv', '2fv', '2fv', '1f', '1i', '1i' ]
);
if ( !prg ) { return; }
...
let render = () => {
    ...
    prg.push_shader( [ resolution, mousePosition, mousePositionP, mouseDown, nowTime, 1 - bufferIndex, textureNumCat ] );
