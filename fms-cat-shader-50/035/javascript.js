...
let prg = gl3.program.create_from_source(
    ...
    [ 'position' ],
    [ 3 ],
    [ 'resolution', 'mouse', 'mouseP', 'mouseDown', 'time', 'prevScene', 'textureCat', 'textureRandom' ],
    [ '2fv', '2fv', '2fv', '2fv', '1f', '1i', '1i', '1i' ]
);
if ( !prg ) { return; }
...
// テクスチャのロード
let textureNumCat = 2;
gl3.create_texture_fromsource( WE.images[ 'cat.png' ], textureNumCat );
let textureNumRandom = 3;
...
let render = () => {
    ...
    prg.push_shader( [ resolution, mousePosition, mousePositionP, mouseDown, nowTime, 1 - bufferIndex, textureNumCat, textureNumRandom ] );
