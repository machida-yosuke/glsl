...
(() => {
    ...
    function init(texture){
        ...
        scenePrg.attLocation[1] = gl.getAttribLocation(scenePrg.program, 'normal');
        scenePrg.attLocation[2] = gl.getAttribLocation(scenePrg.program, 'color');
        scenePrg.attStride[0]   = 3;
        scenePrg.attStride[1]   = 3;
        scenePrg.attStride[2]   = 4;
